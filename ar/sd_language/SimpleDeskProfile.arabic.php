...
//@{
$txt['shd_profile_area'] = 'مكتب المساعدة';
...
$txt['shd_profile_permissions'] = 'الأذونات';
$txt['shd_profile_actionlog'] = 'سجل الإجراءات';
...
$txt['shd_profile_log_count_one'] = '1 مدخل';
$txt['shd_profile_log_count_more'] = '%s إدخالات';
$txt['shd_profile_log_none'] = 'This member has not carried out any helpdesk activities.';
$txt['shd_profile_log_member'] = 'عضو';
$txt['shd_profile_log_ip'] = 'الIP:';
$txt['shd_profile_log_date'] = 'التاريخ';
$txt['shd_profile_log_action'] = 'اجراء';
