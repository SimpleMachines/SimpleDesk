...
//@{
$txt['shd_profile_area'] = 'Служба поддержки';
...
$txt['shd_profile_permissions'] = 'Права доступа';
...
$txt['shd_profile_log_count_one'] = '1 запись';
$txt['shd_profile_log_count_more'] = '%s записей';
$txt['shd_profile_log_none'] = 'This member has not carried out any helpdesk activities.';
$txt['shd_profile_log_member'] = 'Участник';
$txt['shd_profile_log_ip'] = 'IP пользователя:';
$txt['shd_profile_log_date'] = 'Дата';
$txt['shd_profile_log_action'] = 'Действие';
