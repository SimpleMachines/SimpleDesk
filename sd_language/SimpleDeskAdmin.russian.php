...
//@{
$txt['core_settings_item_shd'] = 'Служба поддержки';
...
$txt['lang_file_desc_SimpleDeskPermissions'] = 'Права доступа';
...
$txt['shd_open_tickets'] = 'Открытые чеки';
$txt['shd_closed_tickets'] = 'Закрытые заявки';
...
$txt['shd_admin_actionlog_action'] = 'Действие';
$txt['shd_admin_actionlog_date'] = 'Дата';
$txt['shd_admin_actionlog_member'] = 'Участник';
...
$txt['shd_admin_adminlog_action'] = 'Действие';
$txt['shd_admin_adminlog_name'] = 'Наименование';
$txt['shd_admin_adminlog_to'] = 'To';
$txt['shd_admin_adminlog_from'] = 'From';
$txt['shd_admin_adminlog_setting'] = 'Setting';
$txt['shd_log_admin_canned'] = 'Шаблонные ответы';
$txt['shd_log_admin_customfield'] = 'Пользовательские поля';
$txt['shd_log_admin_maint'] = 'Техническое обслуживание';
$txt['shd_log_admin_permissions'] = 'Права доступа';
$txt['shd_log_admin_plugins'] = 'Плагины';
$txt['shd_log_admin_dept'] = 'Отделы';
$txt['shd_log_admin_change_option'] = 'Варианты';
...
$txt['shd_log_admin_permissions_delete_role'] = 'Удалено';
$txt['shd_log_admin_permissions_change_role'] = 'Обновлено';
$txt['shd_log_admin_permissions_copy_role'] = 'Duplicated';
$txt['shd_log_admin_plugins_update'] = 'Обновлено';
...
$txt['shd_admin_custom_field_options'] = 'Варианты';
...
$txt['shd_admin_custom_field_edit'] = 'Редактирование';
$txt['shd_admin_custom_field_permissions'] = 'Права доступа';
