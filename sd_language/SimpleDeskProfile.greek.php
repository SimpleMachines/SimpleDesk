...
//@{
$txt['shd_profile_area'] = 'Γραφείο Βοήθειας';
...
$txt['shd_profile_permissions'] = 'Δικαιώματα';
...
$txt['shd_profile_log_count_one'] = '1 καταχώριση';
$txt['shd_profile_log_count_more'] = '%s καταχωρήσεις';
$txt['shd_profile_log_none'] = 'This member has not carried out any helpdesk activities.';
$txt['shd_profile_log_member'] = 'Κράτος';
$txt['shd_profile_log_ip'] = 'Ip Μέλους:';
$txt['shd_profile_log_date'] = 'Ημερομηνία';
$txt['shd_profile_log_action'] = 'Ενέργεια';
