...
//@{
$txt['core_settings_item_shd'] = 'Γραφείο Βοήθειας';
...
$txt['lang_file_desc_SimpleDeskPermissions'] = 'Δικαιώματα';
...
$txt['shd_open_tickets'] = 'Ανοιχτές παραγγελίες';
$txt['shd_closed_tickets'] = 'Κλειστά εισιτήρια';
...
$txt['shd_admin_actionlog_action'] = 'Ενέργεια';
$txt['shd_admin_actionlog_date'] = 'Ημερομηνία';
$txt['shd_admin_actionlog_member'] = 'Κράτος';
...
$txt['shd_admin_adminlog_action'] = 'Ενέργεια';
$txt['shd_admin_adminlog_name'] = 'Όνομα';
$txt['shd_admin_adminlog_to'] = 'To';
$txt['shd_admin_adminlog_from'] = 'From';
$txt['shd_admin_adminlog_setting'] = 'Setting';
$txt['shd_log_admin_canned'] = 'Κονσερβοποιημένες Απαντήσεις';
$txt['shd_log_admin_customfield'] = 'Προσαρμοσμένα Πεδία';
$txt['shd_log_admin_maint'] = 'Συντήρηση';
$txt['shd_log_admin_permissions'] = 'Δικαιώματα';
$txt['shd_log_admin_plugins'] = 'Πρόσθετα';
$txt['shd_log_admin_dept'] = 'Τμήματα';
$txt['shd_log_admin_change_option'] = 'Επιλογές';
...
$txt['shd_log_admin_permissions_delete_role'] = 'Διαγράφηκε';
$txt['shd_log_admin_permissions_change_role'] = 'Ενημερώθηκε';
$txt['shd_log_admin_permissions_copy_role'] = 'Duplicated';
$txt['shd_log_admin_plugins_update'] = 'Ενημερώθηκε';
...
$txt['shd_admin_custom_field_options'] = 'Επιλογές';
...
$txt['shd_admin_custom_field_edit'] = 'Επεξεργασία';
$txt['shd_admin_custom_field_permissions'] = 'Δικαιώματα';
