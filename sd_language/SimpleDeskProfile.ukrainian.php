...
$txt['shd_profile_permissions'] = 'Дозволи';
...
$txt['shd_profile_log_count_one'] = '1 запис';
$txt['shd_profile_log_count_more'] = '%s записів';
$txt['shd_profile_log_none'] = 'This member has not carried out any helpdesk activities.';
$txt['shd_profile_log_member'] = 'Гравець';
$txt['shd_profile_log_ip'] = 'IP учасника:';
$txt['shd_profile_log_date'] = 'Дата';
$txt['shd_profile_log_action'] = 'Дія';
