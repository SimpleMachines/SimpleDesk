...
$txt['shd_profile_permissions'] = 'アクセス許可';
...
$txt['shd_profile_log_count_one'] = '1 個の項目';
$txt['shd_profile_log_count_more'] = '%s 項目';
$txt['shd_profile_log_none'] = 'This member has not carried out any helpdesk activities.';
$txt['shd_profile_log_member'] = 'メンバー';
$txt['shd_profile_log_ip'] = 'メンバー IP:';
$txt['shd_profile_log_date'] = '日付';
$txt['shd_profile_log_action'] = 'アクション';
